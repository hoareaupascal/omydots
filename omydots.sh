...
EOF
  ...
  "Tokyo Night")
    ...
    ;;
  "Catpuccin Latte")
    v_name="catpuccin-latte"
    a_theme="catpuccin-latte.toml"
    n_theme="catpuccin-latte.lua"
    b_theme="catpuccin-latte.theme"
    o_theme="catpuccin"
    ;;
  "Catpuccin Mocha")
    v_name="tokyonight"
  ...
  "Everforest")
    v_name="everforest"
    a_theme="everforest.toml"
    n_theme="everforest.lua"
    b_theme="everforest.theme"
    o_theme="everforest"
    ;;
  "Osaka-Jade")
    v_name="osaka-jade"
    a_theme="osaka-jade.toml"
    n_theme="osaka-jade.lua"
    b_theme="osaka-jade.theme"
    o_theme="osaka-jade"
    ;;
  "City 783")
    v_name="city-783"
  ...
  "Synthwave84")
    v_name="synthwave84"
    a_theme="synthwave84.toml"
    n_theme="synthwave84.lua"
    b_theme="synthwave84.theme"
    o_theme="synthwave84"
    ;;
